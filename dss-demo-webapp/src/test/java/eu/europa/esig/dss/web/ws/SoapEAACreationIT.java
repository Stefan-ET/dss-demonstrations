...
public class SoapEAACreationIT extends AbstractIT {

    private SoapEAACreationService eaaService;

    @BeforeEach
    public void init() {
        JaxWsProxyFactoryBean factory = new JaxWsProxyFactoryBean();
        factory.setServiceClass(SoapEAACreationService.class);

        Map<String, Object> props = new HashMap<>();
        props.put("mtom-enabled", Boolean.TRUE);
        factory.setProperties(props);

        factory.setAddress(getBaseCxf() + CXFConfig.SOAP_EAA_CREATION);
        ...
        eaaService = factory.create(SoapEAACreationService.class);
    }
